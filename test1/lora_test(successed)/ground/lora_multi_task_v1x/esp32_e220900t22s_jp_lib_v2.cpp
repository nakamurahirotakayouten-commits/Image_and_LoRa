...
int CLoRa::InitLoRaModule(struct LoRaConfigItem_t &config) {
  ...
  // //ここから
  // SerialMon.printf("command=%d\n", command.size());
  // SerialMon.printf("response=%d\n", response.size());
  
  // for(auto d: response){
  //     SerialMon.printf("%02X ", d);
  // }
  // SerialMon.println();
  // //ここまで
...
// 
  // SerialMon.print("AUX before = ");
  // SerialMon.println(digitalRead(LoRa_AUXPin));
// 
  // digitalWrite(LoRa_ModeSettingPin_M0, HIGH);
  // digitalWrite(LoRa_ModeSettingPin_M1, HIGH);
// 
  // delay(10);
  ...
  // SerialMon.print("AUX after = ");
  // SerialMon.println(digitalRead(LoRa_AUXPin));
// 
  // delay(100);
  // SerialMon.printf("M0=%d M1=%d AUX=%d\n",
    // digitalRead(LoRa_ModeSettingPin_M0),
    // digitalRead(LoRa_ModeSettingPin_M1),
  ...
  digitalWrite(LoRa_ModeSettingPin_M0, 1); //もともと1だったよ
  digitalWrite(LoRa_ModeSettingPin_M1, 1); //もともと1だったよ
  delay(100);
}
